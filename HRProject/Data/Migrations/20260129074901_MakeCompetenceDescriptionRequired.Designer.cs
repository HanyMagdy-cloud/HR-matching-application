...
namespace HRProject.Data.Migrations
{
    ...
    [Migration("20260129074901_MakeCompetenceDescriptionRequired")]
    partial class MakeCompetenceDescriptionRequired
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRProject.Models.ProjectRequirement", b =>
                {
                    ...
                    b.HasOne("HRProject.Models.ProjectManager", "Project")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HRProject.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
